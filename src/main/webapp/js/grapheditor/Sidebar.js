...
Sidebar.prototype.addMBTPalette = function(expand)
{
	...
	var fns = [
		this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.flowchart.terminator;whiteSpace=wrap;fillColor=#fff2cc;strokeColor=#d6b656;rotatable=0;resizable=0;', 
			120, 60, '开始', 'Begin', null, null, 'mbt begin start terminator'),
		this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.flowchart.terminator;whiteSpace=wrap;fillColor=#fff2cc;strokeColor=#d6b656;rotatable=0;resizable=0;', 
			120, 60, '结束', 'End', null, null, 'mbt end terminator'),
		this.createVertexTemplateEntry('ellipse;strokeWidth=2;html=1;whiteSpace=wrap;fillColor=#f8cecc;strokeColor=#b85450;rotatable=0;resizable=0;', 
			120, 60, '异常', 'Exception', null, null, 'mbt exception error'),
		this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.basic.octagon2;dx=0;whiteSpace=wrap;fillColor=#dae8fc;strokeColor=#6c8ebf;rotatable=0;resizable=0;', 
			120, 60, '流程', 'Process', null, null, 'mbt process action'),
		this.createVertexTemplateEntry('strokeWidth=2;rhombus;html=1;whiteSpace=wrap;fillColor=#dae8fc;strokeColor=#6c8ebf;rotatable=0;resizable=0;', 
			120, 60, '分支', 'Decision', null, null, 'mbt decision condition'),
		this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.basic.octagon2;dx=10;whiteSpace=wrap;fillColor=#d5e8d4;strokeColor=#82b366;rotatable=0;resizable=0;', 
